              ...
              <Div className="courseSubmit_row">
                ...
                <Div className="courseSubmit_input_box">
                  <select name="preferredClassMethod" onChange={onChange}>
                    ...
                    <option value="전화/영상스페인어">
                      (전화/영상스페인어) 영상 통화와 음성 통화로 수업하고 싶어요.
                    </option>
                  </select>
                </Div>
              </Div>
          ...
          {data && (
            <>
              <SubmitClassCompletedView
                ...
                desiredDaysAndHours={data.desiredDaysAndHours}
                finishDate={data.finishDate}
                kakaoId={data.kakaoId}
                nameEn={data.nameEn}
                nameKr={data.nameKr}
                pathHowToKnow={data.pathHowToKnow}
                payAmount={data.payAmount}
                payDate={data.payDate}
                payNumber={data.payNumber}
                payStatus={data.payStatus}
                phoneNumber={data.phoneNumber}
                phoneNumberForReceipt={data.phoneNumberForReceipt}
                preferredClassMethod={data.preferredClassMethod}
                preferredTeacher={data.preferredTeacher}
                purposeOfStudy={data.purposeOfStudy}
