  ...
  <Div className="faq_main_vw">
    <Div className="faq_main_vw_li">
      ...
      <Div className="faq_main_vw_content">
        깔깔스페인어 전화 영어 수업은 [스카이프] 프로그램을 이용합니다. 음성수업과 영상수업 둘 다 선택할 수 있으며, 가격
        차이는 없으며 신청하신 수업 스케줄에 맞춰 강사님을 매칭해 드립니다. 모바일보다는 PC를 추천해드립니다. 또한, 교재
        위주의 수업, 일상생활 대화, 토론, 발음, 시험 등 원하시는 수업 방식을 알려주시면 최적의 선생님을 매칭해
        도와드리겠습니다.
      </Div>
    </Div>
    <Div className="faq_main_vw_li">
    ...
    <Div className="faq_main_vw_li">
      ...
      <Div className="faq_main_vw_content">
        부득이하게 수업 참석이 어려우면 사전(최소 1일)에 &quot;마이홈페이지&quot; 를 통해 글을 남겨주시면 보충 수업이
        월별 1달에 2회~5회 (한달 수업횟수에 따라 변경)까지 수업 차감 없이 수업 연기가 가능합니다. 예를 들어 12월 10일
        오전 10시 수업인 경우, 늦어도 12월 9일 오전 10시 이전에는 연기 신청을 해주셔야 합니다. 또한, 연기 신청을 할 수
        있는 횟수 제한이 있어서 주 2회, 30분 수업을 듣고 있다면, 4주 수업 동안 2번의 연기가 가능하고 주 3회 수업이라면
        3회로 제한됩니다. 휴강신청(일시정지)을 하고 싶으신 경우에도 마찬가지로 최소 수업 24시간 전에 신청하신 후, 최대
        1년까지 홀딩 가능하며, 추후 재스케줄링하여 수업 진행하실 수 있습니다. 추후 스케줄링 시 수업 시간 및 강사변경 될
        수 있는 점 참고해 주세요.
      </Div>
    </Div>
    <Div className="faq_main_vw_li">
